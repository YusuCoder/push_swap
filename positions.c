...
/*   Updated: 2024/05/06 21:24:18 by mac              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
                      ...
                      int t_index, int position)
{
    ...
    while (tmp_a)
    {
        if (!found_target && temp_a->index > b_idx && temp_a->index < t_index)
        {
            t_index = temp_a->index;
            position = temp_a->pos;
            found_target = 1;
        }
        else if (temp_a->index < t_index && temp_a->index > b_idx)
        {
            t_index = temp_a->index;
            position = temp_a->pos;
        }
...
void	position(t_ryusupov **r_stack_a, t_ryusupov **r_stack_b)
{
	...
	while (temp_b)
	{
		position = get_target(r_stack_a, temp_b->index, INT_MAX, position);
